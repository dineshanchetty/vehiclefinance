            ...
            return (
              <button
                ...
                className={`relative aspect-square rounded-md overflow-hidden border-2 transition-all ${
                  isActive ? 'border-claimtec-forest shadow-md ring-2 ring-claimtec-forest/20' : 'border-gray-200 hover:border-claimtec-forest/30'
                }`}
              ...
              >
                ...
                <div className={`absolute inset-x-0 bottom-0 px-1 py-0.5 text-[8px] font-semibold leading-none truncate ${
                  isActive ? 'bg-claimtec-forest text-white' : 'bg-black/60 text-white'
                }`}>
                  {p.label}
                </div>
              </button>
