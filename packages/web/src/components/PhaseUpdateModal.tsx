              ...
              return (
                <li
                  ...
                  className={`flex items-center gap-3 rounded-lg border px-3 py-2 transition-colors ${
                    isCurrent ? 'border-indigo-300 bg-indigo-50/40' : 'border-gray-200 hover:bg-gray-50'
                  }`}
                >
                  ...
                  >
                    <p className={`text-sm font-medium ${isCurrent ? 'text-indigo-900' : 'text-gray-900'}`}>
                      {p.name}
                      {isCurrent && <span className="ml-2 text-[10px] uppercase tracking-wide rounded-full bg-indigo-200 text-indigo-800 px-1.5 py-0.5">current</span>}
