          ...
          <>
            ...
            <div className="flex items-end gap-2">
              <textarea
                ...
                rows={1}
                className="min-h-[36px] flex-1 resize-none rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-claimtec-forest focus:outline-none disabled:opacity-50"
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-lg bg-claimtec-forest px-3 py-2 text-sm font-medium text-white hover:bg-claimtec-forest-2 disabled:cursor-not-allowed disabled:bg-gray-300"
...
function TabButton({
  ...
  return (
    ...
    >
      {children}
      {unread && (
        <span className="ml-1.5 inline-block h-1.5 w-1.5 rounded-full bg-claimtec-forest align-middle" />
      )}
    </button>
  )
}
...
function MessageBubble({
  ...
  const bubbleColor = isUser
    ...
    : opsSent
      ? 'bg-claimtec-forest/5 border-claimtec-forest/20 text-gray-900'
      : isAssistant
