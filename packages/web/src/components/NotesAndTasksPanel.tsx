        ...
        <div>
          ...
          <div className="mt-2 flex items-start gap-2">
            <textarea
              ...
              className="flex-1 text-xs rounded-lg border border-gray-200 px-2.5 py-1.5 focus:border-indigo-500 focus:outline-none resize-none"
            />
            <button
              type="button"
        ...
        <div>
          ...
          <div className="mt-2 grid grid-cols-1 gap-1.5">
            <input
              ...
              className="text-xs rounded-lg border border-gray-200 px-2.5 py-1.5 focus:border-indigo-500 focus:outline-none"
            />
            <div className="grid grid-cols-2 gap-1.5">
              <select
                value={taskDraft.priority}
                onChange={(e) => setTaskDraft({ ...taskDraft, priority: e.target.value as TaskWriteInput['priority'] })}
                className="text-xs rounded-lg border border-gray-200 px-2 py-1.5 focus:border-indigo-500 focus:outline-none"
              >
            ...
            <textarea
              ...
              rows={2}
              className="text-xs rounded-lg border border-gray-200 px-2.5 py-1.5 focus:border-indigo-500 focus:outline-none resize-none"
            />
            <button
              type="button"
              onClick={handleCreateTask}
              disabled={!taskDraft.task_type.trim() || savingTask}
              className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 px-3 py-1.5 text-xs font-medium text-white disabled:opacity-50"
            >
