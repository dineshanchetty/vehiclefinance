      ...
      <div className="w-full max-w-2xl rounded-xl bg-white shadow-xl flex flex-col max-h-[80vh]">
        ...
        <div className="px-5 pt-3 pb-2 border-b border-gray-100">
          <input
            ...
            placeholder="Filter…"
            className="w-full rounded-lg border border-gray-200 px-3 py-1.5 text-xs focus:border-claimtec-forest focus:outline-none"
          />
        </div>
                    ...
                    return (
                      <button
                        ...
                        className={`group flex items-center gap-1 rounded-lg px-2 py-1 transition-colors ${
                          isCurrent
                            ? 'ring-2 ring-claimtec-forest ring-offset-1 cursor-default'
                            : 'hover:bg-gray-50 cursor-pointer'
                        }`}
                      >
                        <StatusBadge status={s} variant="sm" />
                        {isCurrent && <span className="text-[10px] text-claimtec-forest font-medium">current</span>}
                      </button>
                    )
                  })}
                </div>
