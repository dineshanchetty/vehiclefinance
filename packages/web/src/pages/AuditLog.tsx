...
const eventTypeColor: Record<string, string> = {
  ...
  DEAL_STATUS_CHANGED:  'text-indigo-700 bg-indigo-50',
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-lg border border-gray-200 bg-white py-2 pl-3 pr-7 text-sm text-gray-700 focus:border-indigo-500 focus:outline-none"
            >
          ...
          <input
            ...
            className="rounded-lg border border-gray-200 bg-white py-2 px-3 text-sm text-gray-700 focus:border-indigo-500 focus:outline-none"
          />
          <input
            type="date"
            value={dateTo}
